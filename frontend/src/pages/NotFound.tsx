...
export function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-20 text-center">
      <div className="relative flex h-24 w-24 items-center justify-center rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface-raised)]/80 shadow-2xl backdrop-blur-xl">
        <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle,rgba(0,242,254,0.2)_0%,transparent_70%)] animate-pulse" />
        <Compass size={40} className="relative z-10 text-[var(--color-accent)] animate-spin" style={{ animationDuration: "12s" }} />
      </div>
